...
----
	...
	com.microwang.springboot.App started
----
...
The easiest to get started with is probably com.microwang.springboot.App Engine, but you could also find ways to run Spring Boot in a container with Container Engine or on a virtual machine with Compute Engine.

To run in com.microwang.springboot.App Engine, you can create a project in the UI first, which sets up a unique identifier for you and also sets up HTTP routes.
...
com.microwang.springboot.App Engine Standard requires you to use WAR packaging.
Follow https://github.com/GoogleCloudPlatform/java-docs-samples/tree/master/appengine-java8/springboot-helloworld/README.md[these steps] to deploy com.microwang.springboot.App Engine Standard application to Google Cloud.

Alternatively, com.microwang.springboot.App Engine Flex requires you to create an `app.yaml` file to describe the resources your app requires.
